...
if __name__ == "__main__" :   
    ...
    IDD_Upsala = Cal_IDD(data_Upsala,BeamDirection)
    brag_peak_Upsala = find_blagPeak(IDD_Upsala)
    plot_idd(IDD_Upsala)
    plot_idd_2(IDD_CS,IDD_Upsala)
    print 'data_CS.shape = ' + str(data_CS.shape) + ','  +  'data_Upsala.shape = ' + str(data_Upsala.shape)
    print 'brag_peak_CS = ' + str(brag_peak_CS) + ','  +  'brag_peak_Upsala = ' + str(brag_peak_Upsala)
